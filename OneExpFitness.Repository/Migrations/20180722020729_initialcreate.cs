        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GymPrice = table.Column<decimal>(nullable: false),
                    GymAddress1 = table.Column<string>(nullable: true),
                    GymAddress2 = table.Column<string>(nullable: true),
                    GymUrl = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CertificationCourseId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CertificationCost = table.Column<decimal>(nullable: false),
                    CourseLength = table.Column<short>(nullable: false),
                    CertificationLink = table.Column<string>(nullable: true),
                    CompanyId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Courses", x => x.CertificationCourseId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GroupActivityId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    GroupId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupActivities", x => x.GroupActivityId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CertificateId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CertificateIssuer = table.Column<string>(nullable: true),
                    UserId = table.Column<string>(nullable: true),
                    CertificationCourseId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certifications_Courses_CertificationCourseId",
                        column: x => x.CertificationCourseId,
                        principalTable: "Courses",
                        principalColumn: "CertificationCourseId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trainers_Certifications_CertificationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GymTrainerId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    TrainerId = table.Column<int>(nullable: false),
                    GymId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GymTrainers", x => x.GymTrainerId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Certifications_CertificationCourseId",
                table: "Certifications",
                column: "CertificationCourseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trainers_CertificationId",
                table: "Trainers",
